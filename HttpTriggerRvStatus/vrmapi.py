...
class VRM_API:
    ...
    def get_user_sites(self, user_id, extended=False):
        ...
        if not extended:
            ...
            sites = self._send_query_request(
                request_url, data_dict={'extended': '1'})
    ...
    def get_consumption_stats(self, inst_id, start=None, end=None):
        ...
        logger.debug(
            "The stats consumption got from the api endpoint is %s " % stats)
        return stats
    ...
    def graph_widgets(self, inst_id, measurement_codes, instance=None, start=None, end=None):
        ...
        request_url = self.WIDGETS_ENDPOINT.format(
            inst_id=inst_id, widget_type='Graph')
